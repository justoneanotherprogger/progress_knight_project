...
// Отладочная ручка для консоли браузера. До модулей gameData был глобалом, и
// правки баланса делались прямо из консоли; переменные модуля оттуда не видны,
// поэтому возвращаем ссылку явно. Объект тот же самый, мутации видны игре сразу;
// переприсваивать window.gameData бесполезно — у модуля своя привязка.
